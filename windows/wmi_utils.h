...
std::wstring wmiValues(std::string tableName, std::string fieldName, std::string condition = "", std::string delimiter = ",");
...
std::vector<std::wstring> _exec(IWbemServices *pSvc, std::string tableName, std::string fieldName, std::string condition = "");
